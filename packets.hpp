...
namespace forza {
	...
	class ForzaPackets {
	public:
		//static const std::array<std::string, 85> props;
        const std::array<std::string, 85> props = {
        ...
        const std::string format = "<iIfffffffffffffffffffffffffffffffffffffffffffffffffffiiiiifffffffffffffffffHBBBBBBbbb";

	public:
		ForzaPackets();

		void write_to_data(char* buf_begin);
